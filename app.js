  ...
  suave: {
    ...
    retos: [
      ...
      { id:'sr7', tipo:'reto', categoria:'suave', quien_genero:'todos', para_genero:'todos',
        texto:'Tómale una foto a ${otro} posando como en una portada de revista.' },
      { id:'sr8', tipo:'reto', categoria:'suave', quien_genero:'todos', para_genero:'todos',
        texto:'Dale la mano a ${otro} y no la sueltes durante los próximos 3 turnos.' },
      { id:'sr9', tipo:'reto', categoria:'suave', quien_genero:'todos', para_genero:'todos',
        texto:'Cuéntale a ${otro} un secreto que nunca le has contado a nadie del grupo.' },
      { id:'sr10', tipo:'reto', categoria:'suave', quien_genero:'mujer', para_genero:'hombre',
        texto:'Hazle una pregunta atrevida a ${otro} y exígele que responda con total honestidad.' },
      { id:'sr11', tipo:'reto', categoria:'suave', quien_genero:'hombre', para_genero:'mujer',
        texto:'Cántale a ${otro} unos segundos de la canción que más te gusta de ella/él.' },
      { id:'sr12', tipo:'reto', categoria:'suave', quien_genero:'todos', para_genero:'todos',
        texto:'Dale la mano a ${otro} y descríbele en voz alta qué sientes al tocarla.' },
      { id:'sr13', tipo:'reto', categoria:'suave', quien_genero:'todos', para_genero:'todos',
        texto:'Imita el gesto o la risa de ${otro} de la forma más exagerada posible.' },
      { id:'sr14', tipo:'reto', categoria:'suave', quien_genero:'mujer', para_genero:'hombre',
        texto:'Camina hacia ${otro} como si fueras modelo en una pasarela y siéntate en sus piernas.' },
      { id:'sr15', tipo:'reto', categoria:'suave', quien_genero:'hombre', para_genero:'mujer',
        texto:'Dile a ${otro}, mirándola a los ojos, tres cosas que te encantan de ella sin dejar de sonreír.' },
    ]
  },
  medio: {
    verdades: [
    ...
    retos: [
      ...
      { id:'mr7', tipo:'reto', categoria:'medio', quien_genero:'todos', para_genero:'todos',
        texto:'Recórrele el brazo a ${otro} con la punta de los dedos, lento, durante 20 segundos.' },
      { id:'mr8', tipo:'reto', categoria:'medio', quien_genero:'todos', para_genero:'todos',
        texto:'Dile a ${otro} al oído, sin que nadie más escuche, lo primero que se te ocurra que te gustaría hacerle.' },
      { id:'mr9', tipo:'reto', categoria:'medio', quien_genero:'mujer', para_genero:'hombre',
        texto:'Quítale la chaqueta o camisa a ${otro} sin usar las manos.', label:'prenda' },
      { id:'mr10', tipo:'reto', categoria:'medio', quien_genero:'hombre', para_genero:'mujer',
        texto:'Bésale la mano a ${otro} y sostén la mirada por 5 segundos completos.' },
      { id:'mr11', tipo:'reto', categoria:'medio', quien_genero:'todos', para_genero:'todos',
        texto:'Dale a ${otro} un beso en la mejilla muy cerca de los labios.' },
      { id:'mr12', tipo:'reto', categoria:'medio', quien_genero:'todos', para_genero:'todos',
        texto:'Acércate a ${otro} y respira cerca de su cuello durante 10 segundos sin tocarlo.' },
      { id:'mr13', tipo:'reto', categoria:'medio', quien_genero:'todos', para_genero:'todos',
        texto:'Dale un beso lento en la mano a ${otro} sin dejar de mirarla a los ojos.' },
      { id:'mr14', tipo:'reto', categoria:'medio', quien_genero:'mujer', para_genero:'hombre',
        texto:'Siéntate de espaldas sobre las piernas de ${otro} y quédate ahí los próximos dos turnos.' },
      { id:'mr15', tipo:'reto', categoria:'medio', quien_genero:'hombre', para_genero:'mujer',
        texto:'Susúrrale a ${otro} cuál es tu fantasía favorita con ella, sin que nadie más escuche.' },
    ]
  },
  recuperacion: {
    retos: [
