...
const IGNITE_CARDS_DEFAULT = {
  suave: {
    verdades: [
      ...
      { id:'sv8', tipo:'verdad', categoria:'suave', quien_genero:'todos', para_genero:'todos',
        texto:'¿Cuál fue tu primera impresión de ${otro} y qué tanto ha cambiado?' },
      { id:'sv9', tipo:'verdad', categoria:'suave', quien_genero:'todos', para_genero:'todos',
        texto:'¿Qué canción te recuerda inmediatamente a un momento especial con ${otro}?' },
      { id:'sv10', tipo:'verdad', categoria:'suave', quien_genero:'mujer', para_genero:'hombre',
        texto:'¿Qué prenda de ropa te gustaría ver puesta a ${otro} más seguido?' },
      { id:'sv11', tipo:'verdad', categoria:'suave', quien_genero:'hombre', para_genero:'mujer',
        texto:'¿Cuál es el cumplido que más te gustaría escuchar de ${otro} ahora mismo?' },
      { id:'sv12', tipo:'verdad', categoria:'suave', quien_genero:'todos', para_genero:'todos',
        texto:'¿Qué pequeño gesto de ${otro} te derrite por completo?' },
      { id:'sv13', tipo:'verdad', categoria:'suave', quien_genero:'todos', para_genero:'todos',
        texto:'¿Qué olor o perfume de ${otro} te resulta irresistible?' },
      { id:'sv14', tipo:'verdad', categoria:'suave', quien_genero:'mujer', para_genero:'hombre',
        texto:'¿Qué gesto tuyo crees que vuelve loco a ${otro}?' },
      { id:'sv15', tipo:'verdad', categoria:'suave', quien_genero:'hombre', para_genero:'mujer',
        texto:'¿Cuál es el lugar de esta casa donde más te gustaría estar a solas con ${otro} ahora mismo?' },
    ],
    retos: [
      { id:'sr1', tipo:'reto', categoria:'suave', quien_genero:'todos', para_genero:'todos',
        texto:'Recórrele el cuello a ${otro} con los labios, despacio, de un lado al otro, durante 20 segundos. Sin besar, solo rozar.' },
      { id:'sr2', tipo:'reto', categoria:'suave', quien_genero:'mujer', para_genero:'hombre',
        texto:'Siéntate a horcajadas sobre ${otro} y perreo lento durante 1 minuto con la canción más caliente que suene. Sin separarse.' },
      { id:'sr3', tipo:'reto', categoria:'suave', quien_genero:'todos', para_genero:'todos',
        texto:'Lame la sal del cuello de ${otro} y toma tu shot. Él/ella elige exactamente dónde poner la sal.' },
      { id:'sr4', tipo:'reto', categoria:'suave', quien_genero:'todos', para_genero:'todos',
        texto:'Dale a ${otro} un beso lento y real en la comisura de los labios. Lo más cerca posible de su boca sin llegar a ella.' },
      { id:'sr5', tipo:'reto', categoria:'suave', quien_genero:'mujer', para_genero:'hombre',
        texto:'Párate frente a ${otro}, tómalo de la corbata o camisa, acércalo hasta que sus narices casi se toquen y susúrrale qué estás pensando en este momento.' },
      { id:'sr6', tipo:'reto', categoria:'suave', quien_genero:'hombre', para_genero:'mujer',
        texto:'Toma a ${otro} por la cintura, acércala despacio y dale un beso largo en el cuello. Tú decides cuánto dura.' },
      { id:'sr7', tipo:'reto', categoria:'suave', quien_genero:'todos', para_genero:'todos',
        texto:'Recórrele la espalda a ${otro} con ambas manos desde la cintura hasta los hombros, despacio, dos veces seguidas.' },
      { id:'sr8', tipo:'reto', categoria:'suave', quien_genero:'todos', para_genero:'todos',
        texto:'Susúrrale al oído de ${otro}, con lujo de detalles, qué fue lo más hot que pensaste hoy antes de llegar.' },
      { id:'sr9', tipo:'reto', categoria:'suave', quien_genero:'todos', para_genero:'todos',
        texto:'Siéntate en las piernas de ${otro} de espaldas, bien pegado/a, y quédate así los próximos 2 turnos sin moverte.' },
      { id:'sr10', tipo:'reto', categoria:'suave', quien_genero:'mujer', para_genero:'hombre',
        texto:'Baila para ${otro} sola durante 1 minuto y medio como si estuvieras en un club, acercándote cada vez más hasta quedar piel con piel.' },
      { id:'sr11', tipo:'reto', categoria:'suave', quien_genero:'hombre', para_genero:'mujer',
        texto:'Recorre con la yema del dedo los labios de ${otro} de un extremo al otro, lento, mirándola a los ojos todo el tiempo.' },
      { id:'sr12', tipo:'reto', categoria:'suave', quien_genero:'todos', para_genero:'todos',
        texto:'Acerca tu boca al oído de ${otro} hasta casi tocarlo y dile, muy despacio, qué parte de su cuerpo más te provoca esta noche.' },
      { id:'sr13', tipo:'reto', categoria:'suave', quien_genero:'todos', para_genero:'todos',
        texto:'Dale a ${otro} un masaje en el cuello y la nuca durante 1 minuto, con intención, sin prisa, sin hablar.' },
      { id:'sr14', tipo:'reto', categoria:'suave', quien_genero:'mujer', para_genero:'hombre',
        texto:'Siéntate de frente sobre las piernas de ${otro}, ponle las manos en los hombros y míralo sin decir nada durante 30 segundos completos.' },
      { id:'sr15', tipo:'reto', categoria:'suave', quien_genero:'hombre', para_genero:'mujer',
        texto:'Párate detrás de ${otro}, ponle los labios en el cuello sin besarla, solo respirando, y susúrrale algo que lleve tiempo queriendo decirle.' },
    ]
  },
  medio: {
    verdades: [
      ...
      { id:'mv7', tipo:'verdad', categoria:'medio', quien_genero:'todos', para_genero:'todos',
        texto:'¿Qué parte del cuerpo de ${otro} te cuesta más dejar de mirar?' },
      { id:'mv8', tipo:'verdad', categoria:'medio', quien_genero:'todos', para_genero:'todos',
        texto:'Si pudieras quitarle una prenda a ${otro} ahora mismo, ¿cuál sería?' },
      { id:'mv9', tipo:'verdad', categoria:'medio', quien_genero:'mujer', para_genero:'hombre',
        texto:'¿Qué fantasía con ${otro} te gustaría cumplir antes de que termine el año?' },
      { id:'mv10', tipo:'verdad', categoria:'medio', quien_genero:'hombre', para_genero:'mujer',
        texto:'¿Qué fue lo más atrevido que pensaste de ${otro} esta semana?' },
      { id:'mv11', tipo:'verdad', categoria:'medio', quien_genero:'todos', para_genero:'todos',
        texto:'En una escala del 1 al 10, ¿qué tan tentado/a estás de besar a ${otro} ahora mismo?' },
      { id:'mv12', tipo:'verdad', categoria:'medio', quien_genero:'todos', para_genero:'todos',
        texto:'¿Qué tan fuerte se te acelera el pulso cuando ${otro} te mira fijamente?' },
      { id:'mv13', tipo:'verdad', categoria:'medio', quien_genero:'mujer', para_genero:'hombre',
        texto:'¿Qué movimiento tuyo crees que más enloquece a ${otro} cuando bailas?' },
      { id:'mv14', tipo:'verdad', categoria:'medio', quien_genero:'hombre', para_genero:'mujer',
        texto:'Si ${otro} te invitara a su habitación ahora mismo, ¿qué pensarías primero?' },
      { id:'mv15', tipo:'verdad', categoria:'medio', quien_genero:'todos', para_genero:'todos',
        texto:'¿Qué es lo más cerca que has estado de besar a alguien del grupo sin hacerlo?' },
    ],
    retos: [
      { id:'mr1', tipo:'reto', categoria:'medio', quien_genero:'todos', para_genero:'todos',
        texto:'Bésate con ${otro} durante 15 segundos completos, despacio, con intención real. Tú decides cuándo termina.' },
      { id:'mr2', tipo:'reto', categoria:'medio', quien_genero:'todos', para_genero:'todos',
        texto:'Toma un hielo y recorre con él desde el cuello de ${otro} hasta donde él/ella decida que puede llegar.' },
      { id:'mr3', tipo:'reto', categoria:'medio', quien_genero:'mujer', para_genero:'hombre',
        texto:'Siéntate a horcajadas sobre ${otro}, ponle las manos en el pecho y dile al oído, sin filtro, lo que quieres que pase esta noche.' },
      { id:'mr4', tipo:'reto', categoria:'medio', quien_genero:'hombre', para_genero:'mujer',
        texto:'Recórrele el cuello y la clavícula a ${otro} con los labios durante 30 segundos, despacio, hasta que se le erice la piel.' },
      { id:'mr5', tipo:'reto', categoria:'medio', quien_genero:'todos', para_genero:'todos',
        texto:'Perreo con ${otro} durante 2 minutos completos con el reguetón más caliente que suene. Sin separarse ni un momento.' },
      { id:'mr6', tipo:'reto', categoria:'medio', quien_genero:'todos', para_genero:'todos',
        texto:'Susúrrale al oído a ${otro}, con lujo de detalle, la fantasía más intensa que tienes con él/ella en este momento.' },
      { id:'mr7', tipo:'reto', categoria:'medio', quien_genero:'todos', para_genero:'todos',
        texto:'Quítale una prenda a ${otro} con una sola mano, despacio, sin dejar de mirarlo a los ojos.', label:'prenda' },
      { id:'mr8', tipo:'reto', categoria:'medio', quien_genero:'mujer', para_genero:'hombre',
        texto:'Quítale la camisa a ${otro} usando solo los dientes. Sin manos. Sin prisa.', label:'prenda' },
      { id:'mr9', tipo:'reto', categoria:'medio', quien_genero:'hombre', para_genero:'mujer',
        texto:'Dale a ${otro} un beso profundo durante 20 segundos seguidos. Sin contar en voz alta, sin apuro.' },
      { id:'mr10', tipo:'reto', categoria:'medio', quien_genero:'todos', para_genero:'todos',
        texto:'Toma el shot del cuerpo de ${otro}: él/ella elige dónde poner la sal y dónde poner el limón. Tú lo tomas todo.' },
      { id:'mr11', tipo:'reto', categoria:'medio', quien_genero:'todos', para_genero:'todos',
        texto:'Recórrele la oreja y el cuello a ${otro} con la lengua, despacio, mientras le susurras qué tan difícil es contenerse.' },
      { id:'mr12', tipo:'reto', categoria:'medio', quien_genero:'mujer', para_genero:'hombre',
        texto:'Baila encima de ${otro} durante 2 minutos como si estuvieran solos, lo más provocador que puedas.' },
      { id:'mr13', tipo:'reto', categoria:'medio', quien_genero:'hombre', para_genero:'mujer',
        texto:'Bésale el cuello a ${otro} subiendo muy despacio hasta la oreja y termina susurrándole lo que más te provoca de ella esta noche.' },
      { id:'mr14', tipo:'reto', categoria:'medio', quien_genero:'todos', para_genero:'todos',
        texto:'Acerca tus labios a los de ${otro} hasta que casi se toquen. Quédate ahí, respirando el mismo aire, hasta que uno de los dos ceda.' },
      { id:'mr15', tipo:'reto', categoria:'medio', quien_genero:'todos', para_genero:'todos',
        texto:'Quítate tú mismo/a una prenda frente a ${otro}, despacio, sosteniéndole la mirada todo el tiempo.', label:'prenda' },
    ]
  },
  recuperacion: {
    retos: [
      { id:'rec1', tipo:'reto', categoria:'recuperacion', quien_genero:'todos', para_genero:'todos',
        texto:'${jugador} elige dónde recibir el licor: cuello/clavícula o abdomen/ombligo. Se pone una rodaja de limón entre los labios y se echa un sorbo pequeño. ${otro} se acerca, bebe directo de la piel y luego le quita el limón de la boca a ${jugador} usando solo sus labios.' },
      { id:'rec2', tipo:'reto', categoria:'recuperacion', quien_genero:'todos', para_genero:'todos',
        texto:'${jugador} elige una canción: "You Can Leave Your Hat On" (Joe Cocker), "Gasolina" (Daddy Yankee) o "Rakata" (Wisin & Yandel). Le baila sensualmente a ${otro} durante 1 minuto completo, provocando y sin apartar la mirada.' },
      { id:'rec3', tipo:'reto', categoria:'recuperacion', quien_genero:'todos', para_genero:'todos',
        texto:'${jugador} confiesa en voz alta frente a todos qué fantasía le gustaría hacer con ${otro} pero que le da vergüenza o miedo admitir. Sin rodeos, sin pena.' },
      { id:'rec4', tipo:'reto', categoria:'recuperacion', quien_genero:'todos', para_genero:'todos',
        texto:'Con reguetón de fondo, ${jugador} se pega a bailar sensualmente con ${otro} durante un minuto completo, sin separarse.' },
      { id:'rec5', tipo:'reto', categoria:'recuperacion', quien_genero:'todos', para_genero:'todos',
        texto:'${jugador} se quita una prenda propia de forma provocativa y despacio para poder recuperar una prenda que había perdido antes en el juego.', label:'prenda' },
      { id:'rec6', tipo:'reto', categoria:'recuperacion', quien_genero:'todos', para_genero:'todos',
        texto:'${jugador} se venda los ojos. Tanto ${otro} como otro participante se acercan. Uno de los dos le da un beso lento en el cuello o la mejilla. ${jugador} debe quitarse la venda y adivinar de quién fue el beso.' },
      { id:'rec7', tipo:'reto', categoria:'recuperacion', quien_genero:'todos', para_genero:'todos',
        texto:'${jugador} sostiene un bombón, una fresa o un trozo de hielo con los labios. ${otro} debe acercarse y tomarlo sin usar las manos.' },
      { id:'rec8', tipo:'reto', categoria:'recuperacion', quien_genero:'todos', para_genero:'todos',
        texto:'${jugador} se acomoda boca abajo. ${otro} le da un masaje con intención en la espalda durante 1:30 minutos, o más si ${jugador} quiere extenderlo.' },
  ...
  hard: {
    verdades: [
      { id:'hv1', tipo:'verdad', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'Mírame a los ojos y dime, sin desviar la mirada: ¿qué tanto me deseas en este momento?' },
      { id:'hv2', tipo:'verdad', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'Describe con todo lujo de detalle la fantasía más intensa que tienes conmigo ahora mismo.' },
      { id:'hv3', tipo:'verdad', categoria:'hard', quien_genero:'mujer', para_genero:'hombre',
        texto:'Dime exactamente qué parte de mi cuerpo se te hace imposible dejar de mirar esta noche.' },
      { id:'hv4', tipo:'verdad', categoria:'hard', quien_genero:'hombre', para_genero:'mujer',
        texto:'Si pudieras hacerme una sola cosa ahora mismo sin que nadie nos viera, ¿cuál sería?' },
      { id:'hv5', tipo:'verdad', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'¿Hasta dónde estás dispuesto/a a llegar conmigo esta noche si yo te digo que sí a todo?' },
      { id:'hv6', tipo:'verdad', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'Confiesa, sin censura: ¿qué es lo más explícito que has imaginado hacer conmigo en este mismo lugar?' },
      { id:'hv7', tipo:'verdad', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'Si esta noche no tuviera ninguna consecuencia, dime exactamente qué me pedirías ahora mismo.' },
      { id:'hv8', tipo:'verdad', categoria:'hard', quien_genero:'mujer', para_genero:'hombre',
        texto:'Describe, sin pena, qué sentirías en el cuerpo si te besara ahora mismo delante de todos.' },
      { id:'hv9', tipo:'verdad', categoria:'hard', quien_genero:'hombre', para_genero:'mujer',
        texto:'¿Qué es lo más atrevido que me harías si supieras que nadie más se va a enterar?' },
      { id:'hv10', tipo:'verdad', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'Confiesa la última vez que pensaste en mí de forma íntima, y qué estabas haciendo en ese momento.' },
      { id:'hv11', tipo:'verdad', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'Si tuvieras luz verde total conmigo ahora mismo, dime exactamente cuál sería tu primer movimiento.' },
      { id:'hv12', tipo:'verdad', categoria:'hard', quien_genero:'mujer', para_genero:'hombre',
        texto:'Describe sin pena qué se siente en tu cuerpo cuando te miro de la forma en que te estoy mirando ahora.' },
      { id:'hv13', tipo:'verdad', categoria:'hard', quien_genero:'hombre', para_genero:'mujer',
        texto:'¿Qué fantasía conmigo jamás le has contado a nadie, ni siquiera a tus amigas más cercanas?' },
      { id:'hv14', tipo:'verdad', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'¿Qué tan dispuesto/a estás a seguir esto en privado conmigo en cuanto termine el juego?' },
      { id:'hv15', tipo:'verdad', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'Dime, exactamente con qué palabras, qué te gustaría que te hiciera esta noche.' },
    ],
    retos: [
      ...
      { id:'hr6', tipo:'reto', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'Quítale a ${otro} una prenda usando solo la boca, sin usar las manos, despacio.', label:'prenda' },
      ...
      { id:'hr10', tipo:'reto', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'Mirando fijamente a ${otro}, dile exactamente, sin pudor, cómo te gustaría terminar la noche con él/ella.' },
      ...
      { id:'hr14', tipo:'reto', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'Bésate con ${otro} de verdad, profundo, durante 10 segundos completos, sin que nadie cuente en voz alta.' },
      { id:'hr15', tipo:'reto', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'Quítate tú mismo/a una prenda frente a ${otro}, despacio, sosteniéndole la mirada todo el tiempo.', label:'prenda' },
    ]
  }
};
