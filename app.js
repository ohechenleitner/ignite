  ...
  recuperacion: {
    retos: [
      { id:'rec1', tipo:'reto', categoria:'recuperacion', quien_genero:'todos', para_genero:'todos',
        texto:'Baila pegado/a a ${otro}, piel con piel, cadera con cadera, sin dejar ningún espacio entre los dos, durante 2 minutos completos sin reír ni una vez.', label:'prenda' },
      { id:'rec2', tipo:'reto', categoria:'recuperacion', quien_genero:'todos', para_genero:'todos',
        texto:'Susúrrale al oído a ${otro}, con todo el detalle que puedas y sin ninguna censura, exactamente lo que le harías si estuvieran a solas ahora mismo.' },
      { id:'rec3', tipo:'reto', categoria:'recuperacion', quien_genero:'mujer', para_genero:'hombre',
        texto:'Siéntate a horcajadas sobre ${otro}, lo más cerca posible, y dile sin ningún filtro todo lo que quieres que pase esta noche entre ustedes.', label:'prenda' },
      { id:'rec4', tipo:'reto', categoria:'recuperacion', quien_genero:'hombre', para_genero:'mujer',
        texto:'Recórrele el cuello y la clavícula a ${otro} con los labios, despacio, durante 20 segundos completos, sin que se aparte.' },
      { id:'rec5', tipo:'reto', categoria:'recuperacion', quien_genero:'todos', para_genero:'todos',
        texto:'Bésate con ${otro} de verdad, profundo, como si esta fuera la última vez que lo vas a hacer. Tú decides cuándo termina.' },
      { id:'rec6', tipo:'reto', categoria:'recuperacion', quien_genero:'todos', para_genero:'todos',
        texto:'Quítale a ${otro} una prenda, despacio, sin apuro, sosteniéndole la mirada todo el tiempo mientras lo haces.', label:'prenda' },
      { id:'rec7', tipo:'reto', categoria:'recuperacion', quien_genero:'todos', para_genero:'todos',
        texto:'Toma tu shot directamente de la piel de ${otro}, donde él/ella elija, y termina con un beso en ese mismo lugar.' },
      { id:'rec8', tipo:'reto', categoria:'recuperacion', quien_genero:'mujer', para_genero:'hombre',
        texto:'Baila solo para ${otro} como si no existiera nadie más en la sala, acercándote cada vez más hasta quedar piel con piel y sin espacio entre ustedes.' },
      { id:'rec9', tipo:'reto', categoria:'recuperacion', quien_genero:'hombre', para_genero:'mujer',
        texto:'Desabróchale una prenda a ${otro} con una sola mano, despacio, sin dejar de mirarla a los ojos, y déjasela así el resto de la ronda.', label:'prenda' },
      { id:'rec10', tipo:'reto', categoria:'recuperacion', quien_genero:'todos', para_genero:'todos',
        texto:'Acércate a ${otro} hasta que los labios casi se rocen. Mantente ahí, respirando el mismo aire, hasta que tú decidas terminarlo con un beso de verdad.' },
    ]
  },
  hard: {
    verdades: [
