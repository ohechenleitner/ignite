  ...
  recuperacion: {
    retos: [
      { id:'rec1', tipo:'reto', categoria:'recuperacion', quien_genero:'todos', para_genero:'todos',
        texto:'Baila pegado/a a ${otro}, cadera con cadera, sin dejar absolutamente ningún espacio entre los dos, durante 2 minutos completos y sin reír.', label:'prenda' },
      { id:'rec2', tipo:'reto', categoria:'recuperacion', quien_genero:'todos', para_genero:'todos',
        texto:'Susúrrale al oído de ${otro}, con todo lujo de detalle y sin ninguna censura, exactamente lo que te gustaría hacerle si estuvieran completamente solos.' },
      { id:'rec3', tipo:'reto', categoria:'recuperacion', quien_genero:'mujer', para_genero:'hombre',
        texto:'Siéntate a horcajadas sobre ${otro}, mirándolo fijamente a los ojos, y dile sin filtro todo lo que te gustaría que pasara esta noche.', label:'prenda' },
      { id:'rec4', tipo:'reto', categoria:'recuperacion', quien_genero:'hombre', para_genero:'mujer',
        texto:'Recórrele el cuello a ${otro} con los labios, lento, durante 15 segundos completos, sin que se aparte.' },
      { id:'rec5', tipo:'reto', categoria:'recuperacion', quien_genero:'todos', para_genero:'todos',
        texto:'Bésate con ${otro} como si fuera la última vez que lo vas a hacer. Tú decides cuánto dura.' },
      { id:'rec6', tipo:'reto', categoria:'recuperacion', quien_genero:'todos', para_genero:'todos',
        texto:'Quítale a ${otro} una prenda, despacio, mirándolo a los ojos todo el tiempo, sin apurarte ni una vez.', label:'prenda' },
      { id:'rec7', tipo:'reto', categoria:'recuperacion', quien_genero:'todos', para_genero:'todos',
        texto:'Toma tu shot directamente de la piel de ${otro}, donde él/ella elija. El grupo decide si fue suficientemente hot.' },
      { id:'rec8', tipo:'reto', categoria:'recuperacion', quien_genero:'mujer', para_genero:'hombre',
        texto:'Baila solo para ${otro} como si no hubiera nadie más en la sala, acercándote cada vez más hasta quedar piel con piel.' },
      { id:'rec9', tipo:'reto', categoria:'recuperacion', quien_genero:'hombre', para_genero:'mujer',
        texto:'Desabróchale una prenda a ${otro} con una sola mano, sin dejar de mirarla a los ojos, y déjala así el resto de la ronda.', label:'prenda' },
      { id:'rec10', tipo:'reto', categoria:'recuperacion', quien_genero:'todos', para_genero:'todos',
        texto:'Acércate a ${otro} hasta que sus labios casi se rocen. Mantente ahí, respirando el mismo aire, hasta que tú decidas terminarlo con un beso.' },
    ]
  },
  hard: {
    verdades: [
      ...
      { id:'hv6', tipo:'verdad', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'¿Qué es lo más explícito que has fantaseado hacer con ${otro} en este mismo lugar?' },
      { id:'hv7', tipo:'verdad', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'Si esta noche no tuviera consecuencias, ¿qué le pedirías a ${otro} ahora mismo?' },
      { id:'hv8', tipo:'verdad', categoria:'hard', quien_genero:'mujer', para_genero:'hombre',
        texto:'Describe, sin filtro, qué sentirías si ${otro} te besara en este momento delante de todos.' },
      { id:'hv9', tipo:'verdad', categoria:'hard', quien_genero:'hombre', para_genero:'mujer',
        texto:'¿Qué es lo más atrevido que harías con ${otro} si supieras que nadie lo va a recordar mañana?' },
      { id:'hv10', tipo:'verdad', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'Confiesa: ¿alguna vez has fantaseado con ${otro} y con quién más en esa misma fantasía?' },
      { id:'hv11', tipo:'verdad', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'Si tuvieras luz verde total esta noche con ${otro}, ¿qué sería lo primero que harías?' },
      { id:'hv12', tipo:'verdad', categoria:'hard', quien_genero:'mujer', para_genero:'hombre',
        texto:'Describe, sin pena, qué se siente cuando ${otro} te mira de cierta forma.' },
      { id:'hv13', tipo:'verdad', categoria:'hard', quien_genero:'hombre', para_genero:'mujer',
        texto:'¿Qué fantasía tuya con ${otro} jamás le has contado a nadie?' },
      { id:'hv14', tipo:'verdad', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'¿Qué tan dispuesto/a estarías a continuar esto en privado con ${otro} después del juego?' },
      { id:'hv15', tipo:'verdad', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'Confiesa la última vez que pensaste en ${otro} de forma íntima.' },
    ],
    retos: [
      ...
      { id:'hr6', tipo:'reto', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'Quítale a ${otro} una prenda usando solo la boca, sin usar las manos.', label:'prenda' },
      { id:'hr7', tipo:'reto', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'Bésale el cuello a ${otro} durante 10 segundos completos, despacio.' },
      { id:'hr8', tipo:'reto', categoria:'hard', quien_genero:'mujer', para_genero:'hombre',
        texto:'Siéntate sobre las piernas de ${otro} de frente y quédate ahí hasta tu próximo turno.', label:'prenda' },
      { id:'hr9', tipo:'reto', categoria:'hard', quien_genero:'hombre', para_genero:'mujer',
        texto:'Recórrele la espalda a ${otro} con los labios desde el cuello hasta el hombro.' },
      { id:'hr10', tipo:'reto', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'Dile a ${otro}, mirándolo/a fijamente, exactamente cómo te gustaría terminar la noche con él/ella.' },
      { id:'hr11', tipo:'reto', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'Bésale el cuello a ${otro}, subiendo lento hasta la oreja.' },
      { id:'hr12', tipo:'reto', categoria:'hard', quien_genero:'mujer', para_genero:'hombre',
        texto:'Siéntate sobre ${otro} de frente y quédate así el resto de la ronda.' },
      { id:'hr13', tipo:'reto', categoria:'hard', quien_genero:'hombre', para_genero:'mujer',
        texto:'Susúrrale a ${otro} exactamente cómo te gustaría continuar la noche, sin filtro.' },
      { id:'hr14', tipo:'reto', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'Bésate con ${otro} durante 10 segundos completos sin que nadie cuente en voz alta.' },
      { id:'hr15', tipo:'reto', categoria:'hard', quien_genero:'todos', para_genero:'todos',
        texto:'Quítate tú mismo/a una prenda frente a ${otro}, despacio, sin apuros.', label:'prenda' },
    ]
  }
};
